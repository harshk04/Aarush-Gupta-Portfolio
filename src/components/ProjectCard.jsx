...
const ProjectCard = ({ project }) => (
  <motion.article
    ...
    className="ui-surface-strong group relative flex h-full flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white/80 shadow-soft backdrop-blur hover:border-primary/40 dark:border-white/10 dark:bg-white/5"
  >
