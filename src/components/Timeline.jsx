      ...
      {items.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="ui-surface flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:border-primary/40 dark:border-white/10 dark:bg-white/5">
